    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        else
        {
            ...
            extendCell.addProClosure = {(cell:UITableViewCell,isAddProduct:Bool) in
                ...
                if buyCountLab == nil
                {
                    buyCountLab = UILabel(frame:CGRect(x: cell.frame.width-20,y: 5,width: 16,height: 16))
                    buyCountLab?.backgroundColor = COLOR_NUMBER
                    buyCountLab?.layer.cornerRadius = 8
                    buyCountLab?.layer.masksToBounds = true
